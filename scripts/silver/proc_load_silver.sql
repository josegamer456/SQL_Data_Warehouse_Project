...
--     )
    ...
    SELECT
        ...
        CASE UPPER(TRIM(prd_line))
             ...
             WHEN 'T' THEN 'Touring'
             ELSE 'n/a'
        END prd_line, --Map product line codes to descrptive values ,
...
--     )
    ...
    */
    ...
    /*
    ===============================================================================================
                                    ERP PX CAT G1V2 CLEANNING(DATA IS ALREADY GOOD)
    ===============================================================================================
    */
